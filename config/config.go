...
type Prest struct {
	...
	HTTPSCert                string
	HTTPSKey                 string
	MysqlCamel2snake         bool
	MysqlTablePrefix         string
	MysqlColumnPrefix        string
	MysqlInsertWithoutSelect bool
}
...
func viperCfg() {
	...
	viper.SetDefault("mysql.camel2snake", true)
	viper.SetDefault("mysql.tablePrefix", "")
	viper.SetDefault("mysql.columnPrefix", "")
	viper.SetDefault("mysql.insertWithoutSelect", true)
...
func Parse(cfg *Prest) (err error) {
	...
	cfg.MysqlCamel2snake = viper.GetBool("mysql.camel2snake")
	cfg.MysqlTablePrefix = viper.GetString("mysql.tablePrefix")
	cfg.MysqlColumnPrefix = viper.GetString("mysql.columnPrefix")
	cfg.MysqlInsertWithoutSelect = viper.GetBool("mysql.insertWithoutSelect")
	var t []TablesConf
